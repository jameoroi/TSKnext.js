...
export function SectionTitle({ eyebrow, title, href }: { eyebrow: string; title: string; href: string }) {
  return (
    <div className="sec-head mb-5 flex items-end justify-between gap-4">
      ...
      <Link href={href} className="flex items-center gap-1 text-sm font-semibold text-emerald-800">
