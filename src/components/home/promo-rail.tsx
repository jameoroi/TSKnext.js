...
function BannerItem({ row, campaign }: { row: Banner; campaign: boolean }) {
  ...
  const body = (
    <span
      className={`block overflow-hidden rounded-2xl border bg-white shadow-sm ${campaign ? 'aspect-[6/1] min-w-[86%] md:min-w-[70%]' : 'aspect-[16/7] min-w-[78%] sm:min-w-[48%] lg:min-w-[32%]'}`}
    >
