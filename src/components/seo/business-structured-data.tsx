...
function profileFromEnvironment(origin: string, settings: SiteSettings) {
  return buildBusinessProfile({
    ...
    businessTradingName:
      settingText(settings, 'company_name', 'site_title') || process.env.BUSINESS_TRADING_NAME,
    businessTagline:
      settingText(settings, 'company_subtitle', 'site_subtitle') || process.env.BUSINESS_TAGLINE,
    businessDescription:
      settingText(settings, 'site_description', 'company_description') || process.env.BUSINESS_DESCRIPTION,
