...
export default async function Page() {
  ...
  return <>
    <AdminPageHeader title="Flash Sale" description="Automatic discount ranking · shelf preview · countdown configuration"/>
    <FlashSaleManager initialSettings={site.settings || {}} products={catalogue.products || []} csrf={String(session.csrf || '')}/>
  </>;
}
